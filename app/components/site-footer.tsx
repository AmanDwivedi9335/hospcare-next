...
const compliance = ["HIPAA-ready audit trails", "Role based access control", "Data residency controls"];
    ...
    <footer className="border-t border-emerald-100 bg-emerald-50/60">
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6 py-12 lg:flex-row lg:justify-between lg:px-10">
        <div className="space-y-3 text-slate-600">
          <p className="text-lg font-semibold text-slate-900">HospCare SaaS Platform</p>
          ...
          <div className="flex gap-3 text-xs text-emerald-700">
            <span className="rounded-full bg-emerald-100 px-3 py-1">Next.js</span>
            <span className="rounded-full bg-emerald-100 px-3 py-1">Prisma</span>
            <span className="rounded-full bg-emerald-100 px-3 py-1">PostgreSQL</span>
          </div>
        </div>

        <div className="flex flex-col gap-8 text-sm text-slate-600 md:flex-row md:gap-16">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2 text-slate-600">
              <Link href="mailto:sales@hospcare.test" className="transition hover:text-emerald-700">
                sales@hospcare.test
              </Link>
